...
- `tool-editor` — editor application core: `EditorState` (composes command history + selection + tool registry + scene), concrete commands (add/remove/reparent node, set transform, rename)
