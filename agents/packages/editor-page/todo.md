...
Ownership: Flight Editor; evolve this package into the shared artboard/page model rather than creating an XD-specific package.

- Add stable artboard identity, scene-space position, size, background, clipping, scroll viewport, and containment policy.
